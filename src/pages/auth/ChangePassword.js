  ...
  return (
    <AuthLayout title="Change Password">
      ...
      <form className="space-y-5" onSubmit={handleOnSubmit}>
        ...
        <InputField name="password" type="password" placeholder="re-enter password" label="Password (again)" handleOnchange={handleConfirmPasswordField} errorMessage="This Confirm Password is required" isError={isEmailError} inputValue={confirmPassword} />
